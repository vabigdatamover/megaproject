...
var clusteringJSON = "https://raw.githubusercontent.com/vabigdatamover/megaproject/master/input/earthquakes1970-2014-dbscan-processed.json"
  ...
  d3.json(platesJSON, function (data2) {
    ...
    d3.json(queryVolcanoUrl, function (data3) {
      ...
      d3.json(oilFieldsJSON, function (data4) {
        // Perform a GET request to the query URL
        d3.json(clusteringJSON, function (data5) {
          // Perform a GET request to the query URL
...
function createFeatures(earthquakeData, plateData, volcanoData, oilfieldData, clusteringData) {
  ...
  // Add Clustering Data
  var clustering = L.geoJSON(clusteringData, {
    onEachFeature: onEachFeature,
    pointToLayer: function (feature, latlng) {
  ...
  createMap(earthquakes, clustering, plates, volcanos, oilfields);

}

function createMap(earthquakes, clustering, plates, volcanos, oilfields) {
